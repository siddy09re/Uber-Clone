...
const AvailableRide = ({setavailableRide , setconfirmRide , setpickupcoord , setdestinationcoord  ,setShowDriverMarker , DriverDistance}) => {
  ...
  const handleAccept = () => {
    ...
    setComparison(false);
    socket.emit('ride-accepted' , {userId: TravelDetails.user, rideId : TravelDetails._id , DriverDistance :DriverDistance ,CaptainInfo });
